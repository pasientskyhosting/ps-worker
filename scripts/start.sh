...
if [ ! -z "$NEW_RELIC_LICENSE_KEY" ]; then
    ...
    if [ -f /etc/php/7.4/fpm/conf.d/20-newrelic.ini ]; then
        rm -rf /etc/php/7.4/fpm/conf.d/20-newrelic.ini
    fi
    if [ -f /etc/php/7.4/cli/conf.d/20-newrelic.ini ]; then
        rm -rf /etc/php/7.4/cli/conf.d/20-newrelic.ini
    fi
